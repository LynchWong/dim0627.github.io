...
{{% img src="/images/2015-02-14/apigility_top.png" alt="apigility_top" w="1352" h="701" %}}
...
{{% img src="/images/2015-02-14/database.png" alt="database" w="1251" h="762" %}}

今回はこんな感じで設定。

{{% img src="/images/2015-02-14/def_database.png" alt="def_database" w="862" h="647" %}}

## APIを追加する

`APIs`の`Create New API`からAPIを追加する。今回はTasksという名前で作成した。

{{% img src="/images/2015-02-14/create_api.png" alt="create_api" w="567" h="294" %}}
...
{{% img src="/images/2015-02-14/create_service.png" alt="create_service" w="1249" h="477" %}}

こんな感じになる。

{{% img src="/images/2015-02-14/def_service.png" alt="def_service" w="857" h="615" %}}

接続できるか試してみましょう。データがないので、まずはPOSTで格納してみる。

{{% img src="/images/2015-02-14/post_tasks.png" alt="post_tasks" w="1118" h="673" %}}

いけてるっぽい。取得は？

{{% img src="/images/2015-02-14/get_tasks.png" alt="get_tasks" w="1118" h="673" %}}
...
{{% img src="/images/2015-02-14/view.png" alt="view" w="524" h="206" %}}
